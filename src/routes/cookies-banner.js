    ...
    return (
        ...
        <div className="project-content">
            <div className = "row">
                ...
                <img className="img-fluid" src="../images/cookies-banner-projectpage.png"/>
                </div>
            </div>
        ...
        <div className="project-desc">
            ...
            <img className="img-fluid" src = "../images/synthesis.png"/>
            <h3>Storyboarding</h3>
            ...
            <img className="img-fluid" src = "../images/final-storyboard.jpg"/>
            ...
            <img className="img-fluid" src="../images/wireframe.png"/>
            <img className="img-fluid" src="../images/lofi.png"/>
            ...
            <img className="img-fluid" src="../images/hifi.png"/>
            ...
            <img className="img-fluid" src="../images/necessary.png"/>
            <img className="img-fluid" src="../images/all.png"/>
            <img className="img-fluid" src="../images/customize.png"/>
            <img className="img-fluid" src="../images/decline.png"/>
        </div>
        </div>

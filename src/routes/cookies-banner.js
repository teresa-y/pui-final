    ...
    return (
        ...
        <div class="project-content">
            <div class = "row">
                ...
                <img class="img-fluid" src="../images/cookies-banner-projectpage.png"/>
                </div>
            </div>
        ...
        <div class="project-desc">
            ...
            <a href="#final-cookie" class ="btn btn-outline-primary">Jump to Final Product</a>
        </p>
            <h3>
                Problem
            </h3>
            ...
            <img class="img-fluid" src = "../images/synthesis.png"/>
            <h3>Storyboarding</h3>
            ...
            <img class="img-fluid" src = "../images/final-storyboard.jpg"/>
            ...
            <img class="img-fluid" src="../images/wireframe.png"/>
            <img class="img-fluid" src="../images/lofi.png"/>
            ...
            <img class="img-fluid" src="../images/hifi.png"/>
            ...
            <a href="https://www.figma.com/proto/qar8jSQTeEF0osshZVBnFJ/Mid-Fi-%2B-High-Fi-Prototype?node-id=101%3A4&scaling=scale-down&page-id=0%3A1&starting-point-node-id=101%3A4&show-proto-sidebar=1" class ="btn btn-outline-primary">Try it Out!</a><br/>
            </p>
            <img class="img-fluid" src="../images/necessary.png"/>
            <img class="img-fluid" src="../images/all.png"/>
            <img class="img-fluid" src="../images/customize.png"/>
            <img class="img-fluid" src="../images/decline.png"/>
        </div>
        </div>

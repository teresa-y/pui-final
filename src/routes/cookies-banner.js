import cookiesbannerprojectpage from"../images/cookies-banner/cookies-banner-projectpage.png"
import synthesis from "../images/cookies-banner/synthesis.png"
import finalstoryboard from "../images/cookies-banner/final-storyboard.jpg"
import wireframe from "../images/cookies-banner/wireframe.png"
import lofi from "../images/cookies-banner/lofi.png"
import hifi from "../images/cookies-banner/hifi.png"
import necessary from "../images/cookies-banner/necessary.png"
import all from "../images/cookies-banner/all.png"
import customize from "../images/cookies-banner/customize.png"
import decline from "../images/cookies-banner/decline.png"
    ...
    return (
        ...
        <div className="project-content">
            <div className = "row">
                ...
                <img className="img-fluid" src={cookiesbannerprojectpage} alt = "internet cookies banner"/>
                </div>
            </div>
        ...
        <div className="project-desc">
            ...
            <img className="img-fluid" src = {finalstoryboard} alt = "final storyboard"/>
            ...
            <img className="img-fluid" src={wireframe} alt = "cookies banner wireframe"/>
            <img className="img-fluid" src={lofi} alt = "cookies banner lofi prototype"/>
            ...
            <img className="img-fluid" src={hifi} alt="cookies banner hifi prototype"/>
            ...
            <img className="img-fluid" src={necessary} alt="necessary cookies screen"/>
            <img className="img-fluid" src={all} alt="all cookies screen"/>
            <img className="img-fluid" src={customize} alt="customize cookies screen"/>
            <img className="img-fluid" src={decline} alt="decline cookies screen"/>
        </div>
        </div>
